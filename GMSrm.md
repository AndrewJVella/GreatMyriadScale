...
## (Additional) Trivia
* Numeric prefixes (of polygons), and Greek ordinals are interchangable. (That is, "deuterad" can also be called "diarad".)  
* In the Great Myriad Scale, digits are in groups of four, seperated by semi-colons. Commas are also ok to use.
